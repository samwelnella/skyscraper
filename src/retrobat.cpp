...
bool RetroBat::loadOldGameList(const QString &gameListFileString)
{
...
bool RetroBat::skipExisting(QList<GameEntry> &gameEntries, QSharedPointer<Queue> queue) 
{
...
void RetroBat::preserveFromOld(GameEntry &entry)
{
...
void RetroBat::assembleList(QString &finalOutput, QList<GameEntry> &gameEntries)
{
  int dots = 0;
...
bool RetroBat::canSkip()
{
  return true;
}

QString RetroBat::getGameListFileName()
{
  return QString("gamelist.xml");
}

QString RetroBat::getInputFolder()
{
  return QString(QDir::homePath() + "/RetroPie/roms/" + config->platform);
}

QString RetroBat::getGameListFolder()
{
  return config->inputFolder;
}

QString RetroBat::getCoversFolder()
{
  return config->mediaFolder + "/covers";
}

QString RetroBat::getScreenshotsFolder()
{
  return config->mediaFolder + "/screenshots";
}

QString RetroBat::getWheelsFolder()
{
  return config->mediaFolder + "/wheels";
}

QString RetroBat::getMarqueesFolder()
{
  return config->mediaFolder + "/marquees";
}

QString RetroBat::getTexturesFolder() {
  return config->mediaFolder + "/textures";
}

QString RetroBat::getVideosFolder()
{
